    ...
    const {title, content, comment, due, id } = task
      ...
      return(
          <div key={task.id} className="Task">
            <button className="button" onClick={() => this.props.dispatch(deleteTaskForm({id, workflowId}))}>Delete Task</button>
            ...
            <button className="button" onClick={() => this.props.dispatch(addComment(id))}>Add comment</button>
